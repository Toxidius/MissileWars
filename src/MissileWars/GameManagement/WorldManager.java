...
public class WorldManager {
	...
	public WorldManager(){
		...
		worldsDir = new File("MissileWarsGameWorlds");
	...
	/*
	 * Not implemented in missile wars yet... Might not be implemented ever
	 * so long as there is only one missile wars map
	 * 
